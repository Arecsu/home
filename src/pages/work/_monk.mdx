...
<ul class="unstyled-list">
 <li><Icon size="0.95em" marginInline="0 0.1em" iconPath="ri-ruler" /> **Ahmad Rajab** - Visual Identities and Graphic Design</li>
 <li><Icon size="0.95em" marginInline="0 0.1em" iconPath="ri-ui-ux" /> **Madina El-Mostafa** - UI/UX and Graphic Design</li>
 <li><Icon size="0.95em" marginInline="0 0.1em" iconPath="ri-web" /> **Alejandro Romano** - Web Engineering</li>
</ul>
