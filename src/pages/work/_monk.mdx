...
import IconRuler from "~icons/ri/ruler-line"
import IconWindow from "~icons/ri/window-2-fill"
...
<ul class="unstyled-list">
 <li><Icon size="0.95em" marginInline="0 0.1em"><IconRuler /></Icon> **Ahmad Rajab** - Visual Identities and Graphic Design</li>
 <li><Icon size="0.95em" marginInline="0 0.1em"><IconWindow /></Icon> **Madina El-Mostafa** - UI/UX and Graphic Design</li>
 <li><Icon size="0.95em" marginInline="0 0.1em"><IconCode /></Icon> **Alejandro Romano** - Web Engineering</li>
</ul>
