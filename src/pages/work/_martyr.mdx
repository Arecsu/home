...
import allTornPaperWide from "@media/all-torn-paper-wide.png"
import allTornPaperMobile from "@media/all-torn-paper-mobile.png"
...
<h3 style="font-feature-settings: 'calt' 0"
>Engineering \<--\> Arts</h3>
...
<Image
   class="full-width all-torn-paper-wide"
   src={allTornPaperWide}
   alt=""
   width="2700"
   format="avif"
   quality="58"
...
<Image
   class="full-width all-torn-paper-mobile"
   src={allTornPaperMobile}
   alt=""
   width="1500"
   format="avif"
   quality="58"
...
<div class="martyr-marquee-wrapper full-width">
   <MartyrMarquee2 linesNumber={3} spanWordsRepeat={10} />
</div>
